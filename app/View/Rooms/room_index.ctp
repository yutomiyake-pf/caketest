...
<div id="modal" class="hidden">
    <?php echo $this->Form->create('Roomimage',['url' => 'roomIndex','type' => 'file', 'enctype' => 'multipart/form-data',]); ?>
...
<div id="info-modal" class="info-hidden">
    <table border="1" id="info-table">
        <tr><th>ルーム名</th><td>なし</td></tr>
        <tr><th>ルームNO</th><td>0</td></tr>
        <tr><th>作成者</th><td>なし</td></tr>
        <tr><th>作成日時</th><td>なし</td></tr>
        <tr><th>投稿数</th><td id="image-cnt"></td></tr>
    </table>
...
<?php if (isset($roomIndexImages)): ?>
<div id="room-image-wrapper">
    <?php foreach ($roomIndexImages as $image): ?>
